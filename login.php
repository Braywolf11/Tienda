                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="verificar.php" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input id="username" name="username" required="required" type="text" placeholder="username or email@mail.com"/>
                                </p>
                                <p> 
                        ...
                        <div id="register" class="animate form">
                            <form  action="insertlogin.php" autocomplete="on" method="POST"> 
                                <h1> Sign up </h1> 
                                <p> 
                                    <label for="usernamesignup" class="uname" >Your Firstname</label>
                                    <input id="usernamesignup" name="firstnamesignup" required="required" type="text" placeholder="firstname" />
                                </p>
                                <p> 
                                ...
                                <center>
                                    ...
                                    <img src="icons/gmail.png" width="50">&nbsp;
